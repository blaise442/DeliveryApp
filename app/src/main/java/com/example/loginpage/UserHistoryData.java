...
public class UserHistoryData implements Serializable {
    ...
    // User email
    // For any given session, only one user/one user email is being used
    // Hence, this field is static
    ...
    public static String getUserName() { return usrID; }
    ...
    public static ArrayList<UserHistoryData> readHistory(Context context)
    {
